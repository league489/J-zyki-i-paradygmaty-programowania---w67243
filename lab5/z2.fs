...
let szukajWartosciIteracyjnie(drzewo : Wezel, wartosc : int) =
    ...
    let drzewo = new Wezel(2,Some(new Wezel( 5,Some(new Wezel( 4, None, Some(new Wezel(7, None, None)))), None)), Some(new Wezel(8,Some(new Wezel(11, None,None)),Some(new Wezel( 9,None,None)))));
